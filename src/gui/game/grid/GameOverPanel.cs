namespace SpaceShooter.gui
{
    public class GameOverPanel : Panel
    {
        ...
        public GameOverPanel(Control parent, GameForm gameForm)
        {
            ...
            GameMessageLabel gameOverLbl = new GameMessageLabel(this, "OYUN BİTTİ!")
            {
                ForeColor = Color.DarkRed
            };
            gameOverLbl.Top = Parent.ClientRectangle.Height / 2 - (int)(gameOverLabelHeightRatio * gameOverLbl.Height);

            CustomButton gameOverBtn = new CustomButton(this, "Devam et", gameOverButtonWidthRatio, gameOverButtonHeightRatio)
            {
